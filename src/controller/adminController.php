...
if (key($post) == "id_coin_edit") {
    $moneda = new Moneda($post["id_coin_edit"][0]["value"], $post["id_coin_edit"][1]["value"], $post["id_coin_edit"][2]["value"]);
...
if (key($post) == "add_coin") {
    $moneda = new Moneda($post["add_coin"][0], $post["add_coin"][1], $post["add_coin"][2], $post["add_coin"][3], $post["add_coin"][4], $post["add_coin"][5]);
